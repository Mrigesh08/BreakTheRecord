...
// for the negaters just negate the value;
// for the boosters, inc the value by a increment
...
function startSentiment(str) {
    return parseParagraphs(str);
}
...
function calculateSum(wordsArray) {
    ...
    for (var i in wordsArray) {
        ...
        // #TASK
        // check for booster dictionary
        // check for negators dictionary
    }
    return sum;
}
...
console.log(startSentiment("i am happy."));
console.log(startSentiment("i am very happy."));
console.log(startSentiment("i am sad."));
console.log(startSentiment("i am gonna kill and then i am gonna attempt suidcide."));
console.log(startSentiment("i am very very happy"));
console.log(startSentiment("i am happy."));
console.log(startSentiment("i am happy."));
console.log(startSentiment("i am not happy."));